...
<template>
    <div class="h-screen flex flex-col">
        ...
        <div class="flex-1">
            <!-- Desktop Sidebar -->
            <aside
                class="w-[19rem] inset-0 hidden lg:block fixed overflow-y-auto overflow-x-hidden dynamic-bg border-r dynamic-border"
            >
            ...
            <!-- Scrollable Content -->
            <main class="flex flex-col h-full lg:pl-[19rem]">
                <Container
                    vertical
                    fluid
                >
